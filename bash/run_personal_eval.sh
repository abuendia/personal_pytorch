...
CUDA_VISIBLE_DEVICES=1 chrombpnet predict \
    ...
    --bias /oak/stanford/groups/akundaje/abuen/personal_genome/personal_pytorch/models/AFGR_ChromBPNet/Yoruba/models/fold_0/bias_model_scaled.h5 \
    --adjust_bias \
    --checkpoint /oak/stanford/groups/akundaje/abuen/personal_genome/personal_pytorch/models/AFGR_ChromBPNet/Yoruba/models/fold_0/chrombpnet.h5 \
